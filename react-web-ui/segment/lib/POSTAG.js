...
POSTAG.CHSNAME[0x40000000]  = '形容词 形语素';
POSTAG.CHSNAME[0x20000000]  = '区别词 区别语素';
POSTAG.CHSNAME[0x10000000]  = '连词 连语素';
POSTAG.CHSNAME[0x08000000]  = '副词 副语素';
POSTAG.CHSNAME[0x04000000]  = '叹词 叹语素';
POSTAG.CHSNAME[0x02000000]  = '方位词 方位语素';
POSTAG.CHSNAME[0x01000000]  = '成语';
POSTAG.CHSNAME[0x00800000]  = '习语';
POSTAG.CHSNAME[0x00400000]  = '数词 数语素';
POSTAG.CHSNAME[0x00200000] = '数量词';
POSTAG.CHSNAME[0x00100000]  = '名词 名语素';
POSTAG.CHSNAME[0x00080000]  = '拟声词';
POSTAG.CHSNAME[0x00040000]  = '介词';
POSTAG.CHSNAME[0x00020000]  = '量词 量语素';
POSTAG.CHSNAME[0x00010000]  = '代词 代语素';
POSTAG.CHSNAME[0x00008000]  = '处所词';
POSTAG.CHSNAME[0x00004000]  = '时间词';
POSTAG.CHSNAME[0x00002000]  = '助词 助语素';
POSTAG.CHSNAME[0x00001000]  = '动词 动语素';
POSTAG.CHSNAME[0x00000800]  = '标点符号';
POSTAG.CHSNAME[0x00000400]  = '非语素字';
POSTAG.CHSNAME[0x00000200]  = '语气词 语气语素';
POSTAG.CHSNAME[0x00000100]  = '状态词';
POSTAG.CHSNAME[0x00000080] = '人名';
POSTAG.CHSNAME[0x00000040] = '地名';
POSTAG.CHSNAME[0x00000020] = '机构团体';
POSTAG.CHSNAME[0x00000010] = '外文字符';
POSTAG.CHSNAME[0x00000008] = '其他专名';
POSTAG.CHSNAME[0x00000004] = '前接成分';
POSTAG.CHSNAME[0x00000002]  = '后接成分';
POSTAG.CHSNAME[0x00000000]  = '未知';
POSTAG.CHSNAME[0x00000001]  = '网址 邮箱地址';
