...
Segment.prototype.useDefault = function () {
  this
    ...
    // 字典文件
    .loadDict('dict.json')           // 盘古词典
    .loadDict('dict2.json')          // 扩展词典（用于调整原盘古词典）
    .loadDict('dict3.json')          // 扩展词典（用于调整原盘古词典）
    .loadDict('names.json')          // 常见名词、人名
    .loadDict('wildcard.json', 'WILDCARD', true)   // 通配符
    ;
  return this;
};
