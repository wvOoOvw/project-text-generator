  ...
  return <Dialog open={props.open} sx={{ '& .MuiDialog-paper': { width: '100%', maxWidth: 720 } }} onClose={() => props.onClose()}>
    ...
    <DialogContent dividers>
      <Grid container spacing={1}>
        ...
        <Tooltip title='set the length of the record, the longer the length, the better the effect in generation, and at the same time, data storage requires a larger capacity'>
          <Grid item xs={12}>
